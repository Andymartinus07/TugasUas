...
<div class="well well-small">
	<div class="row-fluid">	  
		...
		<div class="btn-group">
		  <a href="product_details.html" class="defaultBtn"><span class=" icon-shopping-cart"></span> BELI</a>
	...
	<div class="row-fluid">	  
		...
		<div class="span6">
			<h5>Sepatu anak terbaru 2022 sepatu anak laki-laki sepatu anak perempuan </h5>
			<p>
			...
			</p>
		</div>
	...
	<div class="row-fluid">	  
		...
		<div class="span6">
			<h5>ADJ-KEMEJA PRIA LENGAN PANJANG KEREN//KEMEJA KEKINIAN TERBARU</h5>
			<p>
			...
			</p>
		</div>
	...
	<div class="row-fluid">	  
		...
		<div class="span6">
			<h5>Tas Sekolah Wanita Versi Ransel Korea Murah Tas Punggung Perempuan</h5>
			<p>
			...
			</p>
		</div>
